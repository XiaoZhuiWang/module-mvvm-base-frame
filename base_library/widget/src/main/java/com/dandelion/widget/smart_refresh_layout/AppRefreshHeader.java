package com.dandelion.widget.smart_refresh_layout;
...
public class AppRefreshHeader extends InternalClassics<AppRefreshHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public AppRefreshHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public AppRefreshHeader setTimeFormat(DateFormat format) {
    ...
    public AppRefreshHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public AppRefreshHeader setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public AppRefreshHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public AppRefreshHeader setTextSizeTime(float size) {
...
//    }
    ...
    public AppRefreshHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
