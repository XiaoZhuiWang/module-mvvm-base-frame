...
public class AppRefreshFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public AppRefreshFooter(Context context, AttributeSet attrs) {
